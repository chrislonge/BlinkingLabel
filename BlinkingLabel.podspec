...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  s.description      = "This CocoaPod provides the ability to use a UILabel that can start and stop blinking."

  s.homepage         = "https://github.com/chrislonge/BlinkingLabel"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Chris (Atticus)" => "chris.longe@capitalone.com" }
